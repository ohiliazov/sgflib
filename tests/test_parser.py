...
from sgflib.exceptions import SGFPropertyValueParseError, SGFPropertyParseError, SGFNodeParseError, SGFGameTreeParseError
    ...
    [
        ...
        (
            ...
            SGFGameTree(
                ...
                variations=[
                    SGFGameTree(nodes=[SGFNode([SGFProperty("W", ["pd"])]), SGFNode([SGFProperty("B", ["dp"])])]),
